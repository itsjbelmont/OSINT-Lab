...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["password"]))){
        $password_err = "<p><a href=\"forgotPassword.php?username=$username\">Forgot your password?</a></p>";
    } else{
...
<body>
    <input type="button" onclick="location.href='./employees.html';" value="Back to employees page" /> 
    <center>
        <div class="wrapper">
            <h2>Login</h2>
